...
export function SecuritySection() {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {securityFeatures.map((feature, index) => {
          ...
          return (
            <Card 
              key={index}
              className="p-6 text-center border-2 border-black hover:shadow-2xl transition-all duration-300 group hover:scale-105 bg-white"
            >
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-black font-bold mb-2">{feature.title}</h3>
      ...
      <Card className="p-8 bg-white border-2 border-red-600 shadow-xl">
        <div className="text-center space-y-4">
          <div className="w-16 h-16 bg-linear-to-br from-red-600 to-red-700 rounded-2xl flex items-center justify-center mx-auto shadow-xl">
            <Shield className="w-8 h-8 text-white" />
          </div>
          <h3 className="text-xl font-bold text-black">Certificación Gubernamental</h3>
