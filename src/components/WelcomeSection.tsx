  ...
  return (
    <div className="text-center space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
        <Card className="p-6 text-center border-none bg-linear-to-br from-blue-500 to-blue-600 text-white shadow-xl hover:shadow-2xl transition-all hover:scale-105">
          <Users className="w-10 h-10 mx-auto mb-3 opacity-90" />
          <div className="text-3xl">12M+</div>
          <div className="text-sm opacity-90">Ciudadanos registrados</div>
        </Card>
        <Card className="p-6 text-center border-none bg-linear-to-br from-red-500 to-red-600 text-white shadow-xl hover:shadow-2xl transition-all hover:scale-105">
          <Building2 className="w-10 h-10 mx-auto mb-3 opacity-90" />
          <div className="text-3xl">8</div>
          <div className="text-sm opacity-90">Entidades públicas</div>
        </Card>
        <Card className="p-6 text-center border-none bg-linear-to-br from-emerald-500 to-emerald-600 text-white shadow-xl hover:shadow-2xl transition-all hover:scale-105">
        ...
        <Card className="p-6 text-center border-none bg-linear-to-br from-amber-500 to-amber-600 text-white shadow-xl hover:shadow-2xl transition-all hover:scale-105">
          <Shield className="w-10 h-10 mx-auto mb-3 opacity-90" />
          <div className="text-3xl">99%</div>
          <div className="text-sm opacity-90">Seguridad garantizada</div>
        </Card>
      </div>
    </div>
  );
